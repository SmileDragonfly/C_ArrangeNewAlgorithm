...
Matrix MoveMatrix(MatrixSize SizeInput, Matrix MatInput, uint8_t Horizontal, uint8_t Vertical)
{
	...
	if (((SizeInput.row +1 ) < (MatInput.row + Vertical))||((SizeInput.column + 1) < (MatInput.column + Horizontal)))
	{
